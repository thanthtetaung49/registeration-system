                            ...
                            <form v-on:submit.prevent="updateEvent">
                                ...
                                <div class="w-full flex my-5">
                                    <div class="w-1/3">
                                        ...
                                        <InputError
                                            :message="
                                                form.errors.lead_instructors_id
                                            "
                                        ></InputError>
                                    </div>
                                    <div class="w-1/3 ms-2">
                                        <InputLabel
                                            :value="'Assist instructor'"
                                        ></InputLabel>
                                        <select
                                ...
                                <div class="w-full flex my-5">
                                    <div class="w-1/4">
                                        ...
                                        ></TextInput>
                                        <InputError
                                            :message="form.errors.max_seats"
                                        ></InputError>
                                    </div>
                                    <div class="w-1/4 ms-2">
                                        <InputLabel
                                            :value="'Event reference id'"
                                        ></InputLabel>
                                        <TextInput
                                            type="number"
                                        ...
                                        <InputError
                                            :message="
                                                form.errors.event_reference_id
                                            "
                                        ></InputError>
                                    </div>
                                    <div class="w-1/4 ms-2">
                                ...
                                <div class="w-full flex my-5">
                                    <div class="w-1/3">
                                        ...
                                        <InputError
                                            :message="
                                                form.errors.early_attendance_min
                                            "
                                        ></InputError>
                                    </div>
                                    <div class="w-1/3 ms-2">
                                        <InputLabel
                                            :value="'Late attendance minutes'"
                                        ></InputLabel>
                                        <select
                                        ...
                                        >
                                            <option value="" selected="">
                                                Open this select late attendance
                                                minutes
                                            </option>
                                            <option value="15">15</option>
                                            <option value="30">30</option>
                                        ...
                                        <InputError
                                            :message="
                                                form.errors.late_attendance_min
                                            "
                                        ></InputError>
                                    </div>
                                    <div class="w-1/3 ms-2">
