    ...
    <div>
        <AuthenticatedLayout>
            <div class="px-10 py-10">
                <header class="mb-10">
                    <h3 class="text-gray-800 text-2xl pb-1 bold dark:text-white">{{ l.events.category.title }}</h3>
                                    ...
                                    <div class="overflow-hidden">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <thead>
                                                <tr>
                                                    <th scope="col"
                                                        ...
                                                        {{ l.events.category.table.no }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.events.category.table.category }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.events.category.table.createdAt }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-end text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.events.category.table.actions }}
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y divide-gray-200">
                                                <tr v-for="(
category, index
                                                    ) in categories.data" :key="category.id">
                                                    <td
                                                    ...
                                                    <td
                                                        ...
                                                        <Link :href="`/category/view/${category.id}`"
                                                            ...
                                                            data-hs-overlay="#hs-scale-animation-modal" v-on:click="
                        ...
                        <div class="flex justify-end w-full">
                            <div class="mb-10 my-5">
                                <Link :href="link.url" v-for="(link, index) in categories.links" :key="index"
