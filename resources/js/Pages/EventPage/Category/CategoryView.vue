  ...
  <div>
    <AuthenticatedLayout>
      <div class="px-10 py-10">
        <header class="mb-10">
          <h3 class="text-gray-800 text-2xl pb-1 bold dark:text-white">Category Details</h3>
            ...
            <div class="mt-5">
              <form>
                <div>
                  ...
                  <TextInput v-model="form.category_name" class="mt-3 w-[30%] text-sm" disabled></TextInput>
                </div>
