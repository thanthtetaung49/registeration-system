...
<template>
  <div class="h-screen overflow-hidden">
    <div class="my-5 ms-10 w-full flex items-center">
      ...
      <div class="ms-5 text-bold text-blue-900 text-center">
    ...
    >
      ...
      <div class="p-4">
        <p class="text-gray-800 dark:text-neutral-400 text-sm border-b pb-5">
          Our web application features a powerful QR code scanner integrated
          seamlessly using the latest web technologies. The QR code scanner
          allows you to quickly and accurately scan QR codes directly from your
          device's camera.
        </p>
