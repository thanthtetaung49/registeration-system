...
const updateCourse = () =>
  form.post(`/attendees/course/update/${props.course.id}`);
</script>
      ...
      <div class="px-10 py-10">
        <header class="mb-10">
          <h3 class="text-gray-800 text-2xl pb-1 bold dark:text-white">{{
            l.attendees.course.courseEditTitle }}</h3>
            ...
            <div class="mt-5">
              <form v-on:submit.prevent="updateCourse">
                <div>
                  ...
                  <TextInput :placeholder="l.attendees.course.placeholder.course"
                    v-model="form.course_name" class="mt-3 w-[30%] text-sm"></TextInput>
