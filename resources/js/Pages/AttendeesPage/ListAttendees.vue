                          ...
                          <tr v-for="(user, index) in userData" :key="user.id">
                            ...
                            >
                             ...
                             <td
                              class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800"
                            >
                                <span v-if="user.attendees_types" class="text-green-900 px-3 py-1 rounded-md bg-green-100 inline-block">
                                    {{ user.attendees_types.name }}
                                </span>
                                <span v-else class="text-red-900 px-3 py-1 rounded-md bg-red-100 inline-block">Not added attendees type</span>
                            </td>
                            <td
                              class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800"
                            >
