...
const saveTrainingList = () =>
    form.post("/attendees/trainingLists/create", {
        onSuccess: () => form.reset("training_name"),
    });
    ...
    <div>
        <AuthenticatedLayout>
            <div class="px-10 py-10">
                <header class="mb-10">
                    <h3 class="text-gray-800 text-2xl pb-1 bold dark:text-white">{{ l.attendees.trainingLists.title }}</h3>
                ...
                <div class="w-full bg-white rounded-lg shadow-md dark:text-white dark:bg-gray-800">
                    <div class="border-b border-gray-200 dark:border-none px-4">
                        ...
                        <div class="mt-5">
                            <form v-on:submit.prevent="saveTrainingList">
                                <div>
                                    <InputLabel :value="l.attendees.trainingLists.labels.trainingName"></InputLabel>
                                    <TextInput :placeholder="l.attendees.trainingLists.placeholder.trainingName" v-model="form.training_name" class="mt-3 w-[30%] text-sm"></TextInput>
                                    <InputError :message="form.errors.training_name"></InputError>
                                </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <thead>
                                                <tr>
                                                    <th scope="col"
                                                        ...
                                                        {{ l.attendees.trainingLists.table.no }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.attendees.trainingLists.table.trainingName }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.attendees.trainingLists.table.createdAt }}
                                                    </th>
                                                    <th scope="col"
                                                        class="py-3 text-end text-xs font-medium text-gray-500 uppercase">
                                                        {{ l.attendees.trainingLists.table.actions }}
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y divide-gray-200">
                                                <tr v-for="(
trainingList, index
                                                    ) in trainingLists.data" :key="trainingLists.id">
                                                    <td
                                                    ...
                                                    <td
                                                        ...
                                                        <Link :href="`/attendees/trainingLists/view/${trainingList.id}`"
                                                        ...
                                                        <Link :href="`/attendees/trainingLists/edit/${trainingList.id}`"
                                                        ...
                                                        <Link :href="`/attendees/trainingLists/delete/${trainingList.id}`"
                        ...
                        <div class="flex justify-end w-full">
                            <div class="mb-10 my-5">
                                <Link :href="link.url" v-for="(link, index) in trainingLists.links" :key="index"
