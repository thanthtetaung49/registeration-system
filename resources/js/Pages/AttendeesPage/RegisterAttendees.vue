                      ...
                      <table class="min-w-full">
                          ...
                          <tr>
                            <th scope="col" class="py-1 ps-3 --exclude-from-ordering">
                              <div class="flex items-center h-5">
                                <input :disabled="!form.attendees_groups_id || !form.events_id" ref="checkBoxAll"
                                  @change="handleSelectAllChackBoxChange(users)" id="hs-table-checkbox-all"
                                  type="checkbox" class="border-gray-300 rounded text-blue-600 focus:ring-blue-500" />
                        ...
                        <tbody class="divide-y divide-gray-200" id="tableBody">
                          <tr v-for="user in users.data" :key="user.id">
                            <td class="py-3 ps-3">
                              <input :disabled="!form.attendees_groups_id || !form.events_id" :value="user.id"
                                :id="`hs-table-checkbox-${user.id}`" type="checkbox"
                ...
                <div class="flex justify-end w-full">
                  <div class="mb-7 my-5">
                    <Link
                      ...
                      v-for="(link, index) in users.links" :key="index" class="border py-2 px-3 text-sm dark:text-white"
                      :class="{
