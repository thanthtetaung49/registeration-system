  ...
  <div>
    <AuthenticatedLayout>
      <div class="px-10 py-10">
        <header class="mb-10">
          <h3 class="text-gray-800 text-2xl pb-1 bold dark:text-white">Attendees Edit</h3>
              ...
              <form v-on:submit.prevent="updateAttendees">
                ...
                <div class="w-full flex justify-end">
                  <button href="/attendees/attendeesLists"
                    class="inline-flex items-center px-4 py-2 bg-slate-100 border border-transparent rounded-md font-semibold text-xs text-slate-800 uppercase tracking-widest hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 transition ease-in-out duration-150 mr-3">{{ l.attendees.button.back }}</button>
