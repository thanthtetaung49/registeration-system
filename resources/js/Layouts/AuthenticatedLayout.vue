...
<template>
  ...
  <div class="h-screen overflow-hidden">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
      <nav class="bg-white border-b border-gray-100 dark:border-gray-900 dark:bg-gray-800 shadow-lg">
            ...
            <div class="flex">
              ...
              <div class="shrink-0 flex items-center">
                <Link :href="route('calendar.index')" class="flex items-center">
                  <ApplicationLogo class="block h-20 w-20 fill-current text-gray-800 dark:text-white" />
                  <span class="ps-5 text-gray-800 dark:text-white">Online Registration System</span>
                </Link>
              </div>
            </div>
                ...
                <Dropdown align="right" width="48">
                  <template #trigger>
                    <span class="inline-flex rounded-md">
                      <button type="button"
                        class="dark:bg-gray-900 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
      ...
      <main v-if="disableStatus != 1" class="w-full flex">
        <div class="w-[20%] bg-white text-left py-10 p-5 dark:bg-gray-800 shadow-lg">
          <NavLink class="pb-2 block dark:text-white" :href="route('calendar.index')"
          ...
          <NavLink class="pb-2 block mt-5 dark:text-white" :href="route('users.management')"
          ...
          <!-- <NavLink class="pb-2 block mt-5 dark:text-white" :href="route('businessCard.index')"
            :active="route().current('businessCard.index')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-4 mr-3">
              <path stroke-linecap="round" stroke-linejoin="round"
                d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
            </svg>
            {{ $l.businessCards.title }}
          </NavLink> -->

          <NavLink class="pb-2 block mt-5 dark:text-white" :href="route('print.index')"
            :active="route().current('print.index')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-4 mr-3">
              <path stroke-linecap="round" stroke-linejoin="round"
